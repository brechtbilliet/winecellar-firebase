...
export class StockPage {
    ...
    onRemove(id: string): void {
        this.sb.removeWine(id);
    }

    onSetRate(item: {id: string, value: number}): void {
        this.sb.setRate(item.id, item.value);
    }

    onSetStock(item: {id: string, value: number}): void {
        this.sb.setStock(item.id, item.value);
    }
}
